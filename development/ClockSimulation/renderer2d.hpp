...
{
public:
    constexpr Renderer2dTriangle(std::array<Coordinates2d::Position, 3> const & corners,
                                 Renderer2d::Color const color)
        : corners_(corners)
        , color_(color)
    {
...
private:
    ...
    struct IndexOrdering
    {
        ...
        constexpr IndexOrdering(uint8_t const min,
        ...
        constexpr IndexOrdering(IndexOrdering const & other) = default;
        constexpr IndexOrdering(IndexOrdering && other) = default;
        constexpr IndexOrdering & operator=(IndexOrdering const & other) = default;
        constexpr IndexOrdering & operator=(IndexOrdering && other) = default;
