...
/*
# Usage: link_to …, confirm: 'dummy_value', prompt: { message: 'Some message', default: 'default value', param: 'name of parameter' }
...
function detect_and_suggest_different_forum() {
    var wordlist = 'lm3* transistor* fet mosfet darlington endstufe stromver* kondensator* widerstand* widerstände vorwiderstand mosfet operationsverstärker op-amp opamp step-up step-down schaltregler schaltwandler spannungsregler spannungswandler stromquelle 230v 12v DC/DC spannungsteiler netzteil akku';
    ...
    if (($('select[name=forum_id]').val() == 1) && $('input[name="post[subject]"]').val().match(analogtechnik_regex) && ($('#suggest_different_forum').length == 0)) {
        ...
        $('#similar_topics').before('<div id="suggest_different_forum" class="box">           Möglicherweise passt der Beitrag besser in das Forum Analogtechnik.<br />Möchtest du ihn lieber dort posten?        <br />  <a href="#yes" id="suggest_different_forum_yes">Ja, Forum ändern</a> - <a href="#no" id="suggest_different_forum_no">Nein, Mikrocontroller und Elektronik passt</a>     </div>');
